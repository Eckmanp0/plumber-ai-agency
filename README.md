...
- [`admin-dashboard.html`](C:/Users/eckma/OneDrive/Pictures/Documents/voice_agent/plumber-ai-agency/dashboard/admin-dashboard.html)
...
`/login` is native via Cloudflare Pages pretty URLs from `login.html`.
